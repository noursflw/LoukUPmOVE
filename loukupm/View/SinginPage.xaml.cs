...

{
    ...
    /// <summary>
    /// Handle back button navigation - Navigate back to LoginPage
    /// </summary>
    protected override bool OnBackButtonPressed()
    {
        try
        {
            MainThread.BeginInvokeOnMainThread(async () =>
            {
                ...
                {
                    Console.WriteLine($"[SinginPage] Back button error: {ex.Message}");
                }
            });
            return true;
        }
        ...
        {
            Console.WriteLine($"[SinginPage] OnBackButtonPressed crash: {ex.Message}");
            return true;
        }
    }
